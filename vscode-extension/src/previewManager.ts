...
import { Command, serializeCommand } from "./protocol";
...
export class PreviewManager {
  ...
  async addStream(streamId: string, file: string, deviceType: string, runtime: string): Promise<void> {
   ...
   */
  async replaceAllStreams(streamId: string, file: string, deviceType: string, runtime: string): Promise<void> {
